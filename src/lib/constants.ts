export const EMPLOYEES = [
  "Paweł", "Radek", "Sebastian", "Tomek", "Kacper", "Natalia", "Dominik"
] as const;
...
export const TIME_PRESETS = [
  "12:00-19:30", "12:00-20:00", "12:00-20:30", "12:00-21:00", "12:00-21:30", "12:00-22:00",
  "14:00-19:30", "14:00-20:00", "14:00-20:30", "14:00-21:00", "14:00-21:30", "14:00-22:00",
  "16:00-19:30", "16:00-20:00", "16:00-20:30", "16:00-21:30", "16:00-22:00"
] as const;
...
export const CATEGORIES: Record<string, { items: ProductItem[] }> = {
  ...
  "🛍️": {
      items: [
          ...
          { name: "Torby: Duże", type: 's' },
          { name: "Sos: Pojemniki", type: 's' },
          { name: "Sos: Pokrywki", type: 's' },
          { name: "Opakowania na frytki", type: 's' },
          { name: "Folia", type: 's' },
          { name: "Serwetki", type: 's' },
          { name: "Rękawiczki", type: 's' },
  ...
  "📋": {
      items: [
          ...
          { name: "Długopis", type: 's' },
          { name: "Pisak", type: 's' },
          { name: "Zeszyt", type: 's' },
          { name: "Papier do kasy", type: 's' }
      ]
  }
};
